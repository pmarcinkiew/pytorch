...
{//NCHW order only
  ...
  auto kernel = context_.BuildKernelCached(kUpsampleOp, "", "kUpsampleOp");
  ...
  cl::Buffer params_cl(context_.clContext(), CL_MEM_USE_HOST_PTR | CL_MEM_READ_ONLY , sizeof(params), params);
