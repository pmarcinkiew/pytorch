...
TEST(OpenCL, InvSqrtOpenCL) {
  DeviceOption option;
  caffe2::OpenCLContext  context(option);
  EVILONEFLOATTESTEPS(0.25, 2, InvSqrt, 0.01);
}
...
TEST(OpenCL, Scale) {
  ...
  caffe2::math::Scale(5, 2.0 , matrix_in1, matrix_out1, &context);
  ...
  caffe2::math::Scale(9, 2.0 , matrix_in2, matrix_out2, &context);
  ...
  caffe2::math::Scale(12, 2.0 , matrix_in3, matrix_out3, &context);
...
TEST(OpenCL, Transpose1D) {
  ...
  cl::Buffer cl_x(context.GetSingleton().context, CL_MEM_READ_ONLY|CL_MEM_USE_HOST_PTR, sizeof(matrix_in1), matrix_in1);
  cl::Buffer cl_y(context.GetSingleton().context, CL_MEM_WRITE_ONLY, sizeof(matrix_out1));
  ...
  cl::Buffer cl_x2(context.GetSingleton().context, CL_MEM_READ_ONLY|CL_MEM_USE_HOST_PTR, sizeof(matrix_in2), matrix_in2);
  cl::Buffer cl_y2(context.GetSingleton().context, CL_MEM_WRITE_ONLY, sizeof(matrix_out2));
...
TEST(OpenCL, Transpose2D) {
  ...
  cl::Buffer cl_x1(context.GetSingleton().context, CL_MEM_READ_ONLY|CL_MEM_USE_HOST_PTR, sizeof(matrix_in1), &matrix_in1[0][0]);
  cl::Buffer cl_y1(context.GetSingleton().context, CL_MEM_WRITE_ONLY, sizeof(matrix_out1));
  ...
  cl::Buffer cl_x2(context.GetSingleton().context, CL_MEM_READ_ONLY|CL_MEM_USE_HOST_PTR, sizeof(matrix_in2), &matrix_in2[0][0]);
  cl::Buffer cl_y2(context.GetSingleton().context, CL_MEM_WRITE_ONLY, sizeof(matrix_out2));
...
TEST(OpenCL, Transpose3D) {
  ...
  cl::Buffer cl_x2(context.GetSingleton().context, CL_MEM_READ_ONLY|CL_MEM_USE_HOST_PTR, sizeof(matrix_in2), &matrix_in2[0][0][0]);
  cl::Buffer cl_y2(context.GetSingleton().context, CL_MEM_WRITE_ONLY, sizeof(matrix_out2));
  caffe2::math::Transpose(num_axes, &dims_x2[0], &axes2_transpose[0], &cl_x2, &cl_y2, &context);
...
TEST(OpenCL, Transpose3D_GPU) {
  ...
  cl::Buffer cl_x1(context.GetSingleton().context, CL_MEM_READ_ONLY|CL_MEM_USE_HOST_PTR, layers * rows * cols * sizeof(int), mat_in.get());
  cl::Buffer cl_y1(context.GetSingleton().context, CL_MEM_WRITE_ONLY, layers * rows * cols * sizeof(int));
...
TEST(OpenCL, Transpose3D_CHW_2_HWC_and_back) {
  ...
  cl::Buffer cl_x(context.GetSingleton().context, CL_MEM_READ_ONLY|CL_MEM_USE_HOST_PTR, sizeof(matrix_in), matrix_in);
  cl::Buffer cl_y(context.GetSingleton().context, CL_MEM_WRITE_ONLY, sizeof(matrix_out));
...
TEST(OpenCL, Transpose4D_cl_comparison_with_cpu) {
  ...
  cl::Buffer cl_x(context.GetSingleton().context, CL_MEM_READ_ONLY|CL_MEM_USE_HOST_PTR, sizeof(matrix_in), matrix_in);
  cl::Buffer cl_y(context.GetSingleton().context, CL_MEM_WRITE_ONLY, sizeof(matrix_out_cl));
  ...
  cl::Buffer cl_y2(context.GetSingleton().context, CL_MEM_WRITE_ONLY, sizeof(matrix_out_cl2));
...
TEST(OpenCL, Reduce_GPU) {
  ...
  caffe2::math::ReduceMin(X_float_size, X_float, &y_float,
      static_cast<Tensor<OpenCLContext> *>(nullptr), &context);
